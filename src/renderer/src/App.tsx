...
import { ShowWbstContext } from './contexts/ShowWbstContext'
...
export default function App() {
  ...
  const [showWbst, setShowWbst] = useState(false)
  const [showUbst, setShowUbst] = useState(false)
    ...
    const handler = (e: KeyboardEvent) => {
      ...
      if (!inInput) {
        const viewModes = [
          ...
          { binding: bindings.viewStats, mode: 'stats' as const },
  ...
  return (
    ...
    <ShowWbstContext.Provider value={showWbst}>
    <ShowUbstContext.Provider value={showUbst}>
    ...
    </ShowUbstContext.Provider>
    </ShowWbstContext.Provider>
